...
var SpanBorderColor = "#000000";//span border colour
var SpanBgColor = "#FFFFFF"; //span background colour
var MonthYearColor = "#53565A"; //Font Colour of Month and Year in Calendar header.
var WeekHeadColor = "#F8485E"; //var WeekHeadColor="#18861B";//Background Colour in Week header.
var SundayColor = "#D6EBE7"; //var SundayColor="#C0F64F";//Background colour of Sunday.
var SaturdayColor = "#D6EBE7"; //Background colour of Saturday.
var WeekDayColor = "#F3F5D7"; //Background colour of weekdays.
var FontColor = "#53565A"; //colour of font in Calendar day cell.
var TodayColor = "#FFFFFF"; //var TodayColor="#FFFF33";//Background coloor of today.
var SelDateColor = "#2EA1A1"; //var SelDateColor = "#8DD53C";//Background colour of selected date in textbox.
var YrSelColor = "#53565A"; //colour of font of Year selector.
var MthSelColor = "#53565A"; //colour of font of Month selector if "MonthSelector" is "arrow".
var HoverColor = "#E0FF38"; //colour when mouse move over.
var DisableColor = "#999966"; //colour of disabled cell.
var CalBgColor = "#FFFFFF"; //Background colour of Calendar window.
...
function RenderCssCal(bNewCal)
{
	...
	if (Cal.ShowTime === true)
	{
		...
		vCalTime += "<tr><td colspan='8' style=\"text-align:center;\"><input style='width:60px;background-color:#F8485E;color:#ffffff;font-size:x-small;font-weight:bold;text-align:center;cursor:pointer;' onClick='javascript:closewin(\"" + Cal.Ctrl + "\");' type=\"button\" value=\"OK\">&nbsp;<input style='width:60px;background-color:#F8485E;color:#ffffff;font-size:x-small;font-weight:bold;text-align:center;cursor:pointer;' onClick='javascript: winCal.style.visibility = \"hidden\"' type=\"button\" value=\"Cancel\"></td></tr>";
	}
...
function NewCssCal(pCtrl, pFormat, pScroller, pShowTime, pTimeMode, pShowSeconds, pEnableDateMode, pDisplayLeft)
{
    ...
    if (pDisplayLeft !== undefined && (pDisplayLeft == true)) {
    	CalPosOffsetX = -210;
    } else {
    	CalPosOffsetX = -1;
    }
