/*
    ...
    terms of the Do What The (grow up) You Want To Public License, Version 2,
...
datepickr.init = function (element, instanceConfig) {
    ...
    init = function () {
	    ...
	    var isoDate = self.element.value.substring(6, 10) + "-" + 
            self.element.value.substring(3, 5) + "-" + self.element.value.substring(0, 2);
            parsedDate = Date.parse(isoDate);
        }
